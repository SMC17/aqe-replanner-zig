pub const packages = struct {
    pub const @"../tableformat-zig" = struct {
        pub const build_root = "/home/stax/aqe-replanner-zig/../tableformat-zig";
        pub const build_zig = @import("../tableformat-zig");
